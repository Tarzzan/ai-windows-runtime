...
rm -f "${OUT_DIR}/risk-watchlist-report.json" \
  ...
  "${VALIDATION_DIR}/queue-pressure-report-validation.json" \
  ...
  "${VALIDATION_DIR}/capacity-buffer-report-validation.json" \
  ...
  "${VALIDATION_DIR}/throughput-guard-band-report-validation.json" \
  ...
  "${VALIDATION_DIR}/scope-reentry-readiness-report-validation.json" \
...
cp "${OUT_DIR}/governance-friction-report.json" "${BUNDLE_DIR}/"
cp "${OUT_DIR}/cadence-recommendation-report.json" "${BUNDLE_DIR}/"
cp "${OUT_DIR}/execution-focus-report.json" "${BUNDLE_DIR}/"
cp "${OUT_DIR}/owner-load-report.json" "${BUNDLE_DIR}/"
cp "${OUT_DIR}/execution-throttle-report.json" "${BUNDLE_DIR}/"
cp "${OUT_DIR}/priority-corridor-report.json" "${BUNDLE_DIR}/"
...
cp "${OUT_DIR}/portfolio-risk-budget-report.json" "${BUNDLE_DIR}/"
cp "${OUT_DIR}/delivery-intake-sync-report.json" "${BUNDLE_DIR}/"
cp "${OUT_DIR}/execution-reserve-report.json" "${BUNDLE_DIR}/"
...
cp "${OUT_DIR}/scope-acceleration-readiness-report.json" "${BUNDLE_DIR}/"
cp "${OUT_DIR}/intake-acceleration-policy-report.json" "${BUNDLE_DIR}/"
cp "${OUT_DIR}/scope-acceleration-gate-report.json" "${BUNDLE_DIR}/"
...
cp "${OUT_DIR}/post-release-monitor-report.json" "${BUNDLE_DIR}/"
cp "${OUT_DIR}/incident-feedback-report.json" "${BUNDLE_DIR}/"
