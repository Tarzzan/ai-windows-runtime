...
3. Native runtime core prototype in Rust (PE loader + section mapping + import/export parser + API dispatcher + mini linker).
...
10. Dispatch known APIs as implemented/stubbed/missing decisions.
